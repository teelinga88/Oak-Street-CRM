    ...
    <div style={{display:'flex',height:'100vh',fontFamily:'-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif',fontSize:14,color:'#1a1a1a',background:'#fff'}}>
      ...
      <div style={{flex:1,display:'flex',flexDirection:'column',overflow:'hidden',minWidth:0}}>
        ...
        {view==='accounts'&&(
          <>
            <div style={{height:72,boxSizing:'border-box',padding:'0 16px',borderBottom:'0.5px solid #E5E4DF',display:'flex',alignItems:'center',justifyContent:'space-between',flexShrink:0}}>
              ...
              <svg width="120" height="58" viewBox="0 0 680 330" role="img" aria-label="Flatbed truck" style={{flexShrink:0}}><ellipse cx="360" cy="294" rx="290" ry="9" fill="rgba(20,30,40,0.12)"/><circle cx="150" cy="266" r="26" fill="#23272E"/><circle cx="150" cy="266" r="15" fill="#9AA3AD"/><circle cx="150" cy="266" r="5" fill="#5B636C"/><circle cx="460" cy="266" r="26" fill="#23272E"/><circle cx="460" cy="266" r="15" fill="#9AA3AD"/><circle cx="460" cy="266" r="5" fill="#5B636C"/><circle cx="520" cy="266" r="26" fill="#23272E"/><circle cx="520" cy="266" r="15" fill="#9AA3AD"/><circle cx="520" cy="266" r="5" fill="#5B636C"/><rect x="150" y="230" width="430" height="10" rx="2" fill="#2E3540"/><rect x="165" y="110" width="8" height="40" rx="2" fill="#3A4550"/><rect x="162" y="105" width="14" height="8" rx="2" fill="#23272E"/><rect x="80" y="146" width="80" height="84" rx="8" fill="#14304A"/><rect x="90" y="158" width="55" height="40" rx="6" fill="#BFE0F5"/><polygon points="160,230 160,190 195,182 205,230" fill="#1D4468"/><rect x="198" y="210" width="10" height="20" rx="2" fill="#0D1B2A"/><circle cx="207" cy="205" r="5" fill="#FFC94D"/><rect x="230" y="214" width="350" height="16" rx="2" fill="#C9CDD3"/><rect x="250" y="204" width="310" height="10" rx="1" fill="#C68642"/><rect x="250" y="193" width="310" height="10" rx="1" fill="#B5732E"/><rect x="250" y="182" width="310" height="10" rx="1" fill="#C68642"/><rect x="250" y="171" width="310" height="10" rx="1" fill="#B5732E"/><rect x="250" y="160" width="310" height="10" rx="1" fill="#C68642"/><line x1="300" y1="155" x2="300" y2="214" stroke="#2E3540" strokeWidth="3"/><line x1="480" y1="155" x2="480" y2="214" stroke="#2E3540" strokeWidth="3"/><rect x="295" y="214" width="10" height="6" fill="#5B636C"/><rect x="475" y="214" width="10" height="6" fill="#5B636C"/></svg>
        ...
        {view==='manager'&&isManager&&(
          <>
            <div style={{height:72,boxSizing:'border-box',padding:'0 16px',borderBottom:'0.5px solid #E5E4DF',display:'flex',alignItems:'center',flexShrink:0}}>
