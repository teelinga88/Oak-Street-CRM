    ...
    <div style={{display:'flex',height:'100vh',fontFamily:'-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif',fontSize:14,color:'#1a1a1a',background:'#fff'}}>
      ...
      <div style={{flex:1,display:'flex',flexDirection:'column',overflow:'hidden',minWidth:0}}>
        ...
        {view==='accounts'&&(
          <>
            <div style={{height:72,boxSizing:'border-box',padding:'0 16px',borderBottom:'0.5px solid #E5E4DF',display:'flex',alignItems:'center',justifyContent:'space-between',flexShrink:0}}>
              <div style={{display:'flex',alignItems:'center',gap:12}}><h2 style={{fontSize:15,fontWeight:600,margin:0}}>{viewAsRep===repName?'My Accounts':`${viewAsRep.split(' ')[0]}'s Accounts`}</h2><HeaderTruck/></div>
        ...
        {view==='pipeline'&&(
          <>
            <div style={{height:72,boxSizing:'border-box',padding:'0 16px',borderBottom:'0.5px solid #E5E4DF',display:'flex',alignItems:'center',justifyContent:'space-between',flexShrink:0}}>
              <div style={{display:'flex',alignItems:'center',gap:12}}><h2 style={{fontSize:15,fontWeight:600,margin:0}}>{viewAsRep===repName?'My Pipeline':`${viewAsRep.split(' ')[0]}'s Pipeline`}</h2><HeaderTruck/></div>
              <div style={{display:'flex',gap:8}}>
        ...
        {view==='bucket'&&(
          <>
            <div style={{height:72,boxSizing:'border-box',padding:'0 16px',borderBottom:'0.5px solid #E5E4DF',display:'flex',alignItems:'center',justifyContent:'space-between',flexShrink:0}}>
              <div style={{display:'flex',alignItems:'center',gap:12}}><h2 style={{fontSize:15,fontWeight:600,margin:0}}>{viewAsRep.split(' ')[0]}'s Cold Call Bucket</h2><HeaderTruck/></div>
        ...
        {view==='followups'&&(
          <>
            <div style={{height:72,boxSizing:'border-box',padding:'0 16px',borderBottom:'0.5px solid #E5E4DF',display:'flex',alignItems:'center',justifyContent:'space-between',flexShrink:0}}>
              <div style={{display:'flex',alignItems:'center',gap:12}}><h2 style={{fontSize:15,fontWeight:600,margin:0}}>{viewAsRep===repName?'My Follow-ups':`${viewAsRep.split(' ')[0]}'s Follow-ups`}</h2><HeaderTruck/></div>
        ...
        {view==='manager'&&isManager&&(
          <>
            <div style={{height:72,boxSizing:'border-box',padding:'0 16px',borderBottom:'0.5px solid #E5E4DF',display:'flex',alignItems:'center',justifyContent:'space-between',flexShrink:0}}>
              <div style={{display:'flex',alignItems:'center',gap:12}}><h2 style={{fontSize:15,fontWeight:600,margin:0}}>Manager Dashboard</h2><HeaderTruck/></div>
            </div>
            <div style={{flex:1,overflowY:'auto',padding:16}}>
