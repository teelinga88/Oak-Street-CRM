        ...
        {view==='accounts'&&(
          <>
            <div style={{height:72,boxSizing:'border-box',padding:'0 16px',borderBottom:'0.5px solid #E5E4DF',display:'flex',alignItems:'center',justifyContent:'space-between',flexShrink:0}}>
              ...
              <svg width="160" height="42" viewBox="0 0 680 180" role="img" aria-label="Flatbed truck" style={{flexShrink:0}}><ellipse cx="340" cy="152" rx="270" ry="8" fill="rgba(20,25,32,0.12)"/><circle cx="140" cy="126" r="22" fill="#1E2733"/><circle cx="140" cy="126" r="8" fill="#545F6B"/><circle cx="420" cy="126" r="22" fill="#1E2733"/><circle cx="420" cy="126" r="8" fill="#545F6B"/><circle cx="475" cy="126" r="22" fill="#1E2733"/><circle cx="475" cy="126" r="8" fill="#545F6B"/><rect x="140" y="96" width="360" height="8" rx="1" fill="#1E2733"/><polygon points="75,104 75,48 92,34 145,30 168,38 185,66 185,104" fill="#1E2733"/><polygon points="90,52 135,40 152,46 145,70 100,78" fill="#B9C4CE"/><rect x="210" y="90" width="340" height="14" rx="2" fill="#9AA4AF"/><rect x="225" y="36" width="95" height="54" rx="3" fill="#9AA4AF" stroke="#727C88" strokeWidth="1.5"/><line x1="225" y1="63" x2="320" y2="63" stroke="#727C88" strokeWidth="1"/><rect x="330" y="36" width="95" height="54" rx="3" fill="#9AA4AF" stroke="#727C88" strokeWidth="1.5"/><line x1="330" y1="63" x2="425" y2="63" stroke="#727C88" strokeWidth="1"/><rect x="435" y="36" width="95" height="54" rx="3" fill="#9AA4AF" stroke="#727C88" strokeWidth="1.5"/><line x1="435" y1="63" x2="530" y2="63" stroke="#727C88" strokeWidth="1"/><line x1="320" y1="32" x2="320" y2="90" stroke="#1E2733" strokeWidth="2"/><line x1="430" y1="32" x2="430" y2="90" stroke="#1E2733" strokeWidth="2"/></svg>
